...
@Component({
  selector: 'app-animal-adopted',
  templateUrl: './animal-adopted.component.html',
  styleUrls: ['./animal-adopted.component.css']
})
export class AnimalAdoptedComponent implements OnInit {
  categories: Category[];
  ...
  constructor(private _animalService: AnimalService,
    ...
    getAnimals(){
      this._animalService.getAllAdoptedAnimals()
